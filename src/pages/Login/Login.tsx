...
import { Lock, Eye, EyeOff, Sparkles, Mail, Sun, Moon } from 'lucide-react';
            ...
            <div className="bg-[#F4F2EE] dark:bg-[#0A1513]/90 border border-slate-200/60 dark:border-white/10 rounded-2xl p-5 sm:p-6 backdrop-blur-xl shadow-soft dark:shadow-2xl space-y-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center justify-end text-[11px]">
                  <button
                    ...
                    className="font-semibold text-[#728974] dark:text-[#00F5A0] hover:underline"
                  >
                    Forgot Password?
                  </button>
                </div>
                ...
                <Button
                  ...
                  className="w-full h-10 rounded-full bg-[#728974] hover:bg-[#5E7160] text-white font-heading font-bold text-xs shadow-md border-none transition-all duration-200"
                >
                  Sign In Now
                </Button>
              </form>
              ...
              <div className="pt-1 text-center">
                ...
                >
                  ...
                  <span>Auto-fill Demo: <strong className="text-[#728974] dark:text-[#00F5A0]">emilys / emilyspass</strong></span>
                </button>
              </div>
