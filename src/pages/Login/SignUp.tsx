...
import { Lock, Eye, EyeOff, Sparkles, Mail, User } from 'lucide-react';
...
export const SignUp: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Simulate signup registration & auto-login with emilys / emilyspass
            ...
            <div className="bg-[#0A1513]/90 border border-white/10 rounded-2xl p-5 sm:p-6 backdrop-blur-xl shadow-2xl space-y-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-3.5">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative flex items-center">
                    <User className="w-4 h-4 absolute left-3.5 text-[#71717A]" />
                    <input
                      type="text"
                      value={fullName}
                ...
                <Button
                  ...
                  className="w-full h-10 rounded-full bg-gradient-to-r from-[#00F5A0] to-[#22C55E] hover:from-[#00F5A0] hover:to-[#00F5A0] text-[#020B09] font-heading font-extrabold text-xs shadow-[0_0_20px_rgba(0,245,160,0.35)] hover:shadow-[0_0_30px_rgba(0,245,160,0.5)] border-none transition-all duration-200 mt-2"
                >
                  Create Account Now
                </Button>
              </form>
              ...
              <div className="pt-1 text-center">
                ...
                >
                  ...
                  <span>Auto-fill Demo: <strong className="text-[#00F5A0]">Emily Johnson</strong></span>
                </button>
              </div>
